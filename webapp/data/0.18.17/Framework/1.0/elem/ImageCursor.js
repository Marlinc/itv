var ImageCursor = Class.create({
    id: null, imgObj: null, x: 0, getObj: function () {
        ...
        try {
            ...
            this.imgObj.getObj().style.position = "static";
            ...
            if (this.css.styleItemTxt != undefined && (this.css.styleItemTxt.isPresent != undefined && this.css.styleItemTxt.isPresent)) {
                ...
                this.txt_wrapper.style.position = "relative";
            ...
            this.cursor = fw.cssBuilder.createRect(_id +
                "_Curs", this.css.styleItemSelect.style);
        ...
        try {
            ...
            if (this.css.styleItemImg.label == "aanbienders") {
                ...
                if (this.css.styleItemTxt != undefined && (this.css.styleItemTxt.isPresent != undefined && this.css.styleItemTxt.isPresent)) {
                    var txt = "";
                    if (eval("_obj." +
                            this.css.styleItemTxt.label) != undefined && (eval("_obj." + this.css.styleItemTxt.label) != null && eval("_obj." + this.css.styleItemTxt.label) != "")) {
                    ...
                    } else if (eval("_obj." + this.css.styleItemTxt.label2) != undefined && (eval("_obj." + this.css.styleItemTxt.label2) != null && eval("_obj." + this.css.styleItemTxt.label2) != "")) {
                        fw.log.debug("imageCursor label setting value: label2 : " +
                            eval("_obj." + this.css.styleItemTxt.label2));
                ...
                if (_obj.iconURL)url = _obj.iconURL; else try {
                    if (eval("this.css.CoverChannelMap._" + _obj.name.toLowerCase().replace(/ /g, "_")) != undefined)url = this.css.styleItemImg.ottGridImgPrefPath + eval("this.css.CoverChannelMap._" + _obj.name.toLowerCase().replace(/ /g, "_")) + this.css.styleItemImg.ottGridImgExt; else url = this.css.styleItemImg.ottGridImgPrefPath +
                        _obj.name.toLowerCase() + this.css.styleItemImg.ottGridImgExt
                } catch (ex) {
            ...
            if (url == "" && (this.css.styleItemImg.defaultImgUrl != null && (this.css.styleItemImg.defaultImgUrl != undefined && this.css.styleItemImg.defaultImgUrl != "")))url = this.css.styleItemImg.defaultImgUrl;
        ...
        if (this.obj != null && this.obj.iconURL)this.cursor.setStyle(this.css.styleItemSelect.styleOTT); else this.cursor.setStyle(this.css.styleItemSelect.style);
        this.cursor.show()
    }, focusOff: function () {
        this.cursor.hide()
    },
