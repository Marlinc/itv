var ScenarioMessageLargePopup = Class.create(Scenario, {
    initialize: function ($super, _prop, _conf, _parentObj) {
        ...
        try {
            ...
            if (_conf.message != null && (_conf.message != undefined && _conf.message != ""))this.intPopupMessageTxt.setTxt(_conf.message); else this.intPopupMessageTxt.setTxt(eval("this.parentObj.messages." + this.conf.IntPopupDefaultMessageTxt));
            if (_conf.buttonOKlabel != null && (_conf.buttonOKlabel != undefined && _conf.buttonOKlabel != ""))this.intPopupOKBtn.setTxt(_conf.buttonOKlabel.slice(0, this.conf.IntPopupOKAndKOBtnTxtMaxLength));
            else this.intPopupOKBtn.setTxt(eval("this.parentObj.messages." + this.conf.IntPopupDefaultOKBtnTxt));
            ...
            if (_conf.buttonOKstatus != null && (_conf.buttonOKstatus != undefined && _conf.buttonOKstatus != ""))this.intButtonOKstatus = _conf.buttonOKstatus;
